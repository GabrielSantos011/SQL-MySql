/*Preparando ambiente para consultas*/
USE sucos;
...
/*PRIMEIROS 5 - NO MYSQL*/
SELECT CPF FROM tbcliente LIMIT 5;

/*UTILIZANDO ALIASES - COM OU SEM USO DO AS*/
SELECT CPF AS CadastroPessoaFisica, NOME NomeCliente FROM tbcliente; 

/*
FILTRANDO REGISTROS
AO FAZER UM UPDATE E O DELETE JA USAMOS O WHERE
É COM ELE QUE FAZEMOS A CONDIÇÃO DO FILTRO
PORÉM NAQUELES CASOS UTILIZAMOS A CHAVE PRIMÁRIA (PK)
E PODE SER UTILIZADO PARA QUALQUER CAMPO
*/
SELECT * FROM tbproduto WHERE PRODUTO = '1000889';
...
/*float o igual não funciona bem*/
